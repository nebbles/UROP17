...
int main( int argc, char** argv ){
    ...
    namedWindow("copydat", CV_WINDOW_NORMAL);
    resizeWindow("copydat", 1280, 720);
    imshow("copydat", Copy);
